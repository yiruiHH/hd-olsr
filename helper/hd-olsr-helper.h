 ...
 */
#ifndef HDOLSR_HELPER_H
#define HDOLSR_HELPER_H
 ...
 */
class HDOlsrHelper : public Ipv4RoutingHelper
{
public:
  /**
   * Create an HDOlsrHelper that makes life easier for people who want to install
   * OLSR routing to nodes.
   */
  HDOlsrHelper ();

  /**
   * \brief Construct an HDOlsrHelper from another previously initialized instance
   * (Copy Constructor).
   */
  HDOlsrHelper (const HDOlsrHelper &);

  /**
   * \returns pointer to clone of this HDOlsrHelper
   *
   ...
   *
   * This method controls the attributes of ns3::hdolsr::RoutingProtocol
   */
...
private:
   ...
   * \return nothing
   */
  HDOlsrHelper &operator = (const HDOlsrHelper &);
