...
#ifndef HD_OLSR_STATE_H
#define HD_OLSR_STATE_H
...
protected:
  ...
  HdSet m_hdSet;  //!< Highlt Dynamic Set.
...
public:
  ...
  /**
   * Finds a HD tuple.
   * \param mainAddr The HD main address.
   * \returns The HD tuple, if found. Else it returns a null pointer.
   */
  HdTuple* FindHdTuple (const Ipv4Address &mainAddr);

  /**
   * Erases a HD tuple.
   * \param tuple The HD tuple.
   */
  void EraseHdTuple (const HdTuple &tuple);

  /**
   * Erase a HD tuple by the main address.
   * \param mainAddr The HD main address.
   */
  void EraseHdTuple (const Ipv4Address &mainAddr);

  /**
   * Inserts a HD tuple
   * \param tuple The HD tuple.
   */
  void InsertHdTuple (const HdTuple &tuple);

  /**
   * Prints the HD sets.
   * \return a string with the output data.
   */
  std::string PrintHdSet () const;
