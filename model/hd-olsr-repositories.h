...
#ifndef HD_OLSR_REPOSITORIES_H
#define HD_OLSR_REPOSITORIES_H
...
static inline bool
operator == (const HdTuple &a, const HdTuple &b)
{
  return a.neighborMainAddr == b.neighborMainAddr;
}

static inline std::ostream&
operator << (std::ostream &os, const HdTuple &tuple)
{
  os << "HdTuple(neighborMainAddr=" << tuple.neighborMainAddr
     << ", location=" << tuple.location
     << ", speed=" << tuple.velocity << ")";
  return os;
}
...
typedef std::vector<HdTuple>                    HdSet;//!< Highly Dynamic Set type.


}
}  // namespace ns3, olsr

#endif /* HD_OLSR_REPOSITORIES_H */
